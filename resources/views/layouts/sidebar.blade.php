...
<aside class="w-56 min-h-screen bg-sky-950 px-6 py-2 shadow-md shadow-blue-500/50">
                ...
                <li class="my-1">
                    <a 
                        ...
                        class="
                            ...
                            {{ 
                                $menu->active 
                                    ? 'bg-linear-to-r from-blue-700 to-sky-600 shadow-md shadow-blue-500/30 text-white hover:bg-sky-900/30 font-bold' 
                                    : 'text-gray-500 hover:bg-sky-900/40 hover:text-white font-medium'
                            }}
                        "
                    >
    ...
    <div class="mt-5">
        <form action="/logout" method="post">
            ...
            <button 
                type="submit" 
                class="w-full font-bold bg-linear-to-r from-red-600 to-rose-500 hover:from-red-800 hover:to-rose-800 shadow-md shadow-red-500/40 text-white py-2 rounded">
                Logout
            </button>
        </form>
    </div>
